...
public class successfullySubmitted extends javax.swing.JFrame {
    ...
    public successfullySubmitted(String marks) {
        initComponents();
        jLabel1.setText("Marks obtained: " + marks);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Merriweather", 1, 60)); // NOI18N
        jLabel1.setText("Marks Obtained: 10");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 282, 660, -1));

        jLabel2.setFont(new java.awt.Font("Merriweather", 1, 60)); // NOI18N
        jLabel2.setText("Successfully Updated");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 394, -1, -1));
